<template>
    <div>
        <div id="ship" class="container-fluid justify-content-center d-flex text-white fw-bold">
            <router-link class="navbar-brand" to="/cart">ENJOY FREE SHIPPING FOR ORDERS OVER R500. T’S &C’S APPLY <i
